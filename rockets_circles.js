...
function Rocket(genes) {
  ...
  this.update = function() {
    ...
    if ((this.pos.x-150)*(this.pos.x-150) + (this.pos.y-150)*(this.pos.y-150) < (325/2)*(325/2)){
      this.crashed = true;
    }
    if ((this.pos.x-150)*(this.pos.x-150) + (this.pos.y-450)*(this.pos.y-450) < (325/2)*(325/2)){
      this.crashed = true;
    }
    if ((this.pos.x-500)*(this.pos.x-500) + (this.pos.y-300)*(this.pos.y-300) < (325/2)*(325/2)){
      this.crashed = true;
    }
